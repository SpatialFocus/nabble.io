	...
	public class AppVeyorAnalyzerResultAccessorTests
	{
			...
			[Frozen] Mock<IRestClient> restClient)
		{
			...
			AppVeyorAnalyzerResultAccessor resultAccessor = new AppVeyorAnalyzerResultAccessor(
				...
				new AnalyzerResultBuilder() { Rules = new[] { string.Empty } },
				new NullCache(),
				new NullStatisticsService()) { AccountName = "TestAccount", ProjectSlug = "TestProject", ReportFileName = "custom.json" };
			...
			[Frozen] Mock<IRestClient> restClient)
		{
			...
			AppVeyorAnalyzerResultAccessor resultAccessor = new AppVeyorAnalyzerResultAccessor(
				...
				new AnalyzerResultBuilder() { Rules = new[] { string.Empty } },
				new NullCache(),
				new NullStatisticsService()) { AccountName = "TestAccount", ProjectSlug = "TestProject", ReportFileName = "report.json" };
		...
		public async void GetAnalyzerResultAsyncMissingReportThrowsException([Frozen] Mock<IRestClient> restClient)
		{
			...
			AppVeyorAnalyzerResultAccessor resultAccessor = new AppVeyorAnalyzerResultAccessor(
				...
				new AnalyzerResultBuilder() { Rules = new[] { string.Empty } },
				new NullCache(),
				new NullStatisticsService()) { AccountName = "TestAccount", ProjectSlug = "TestProject", ReportFileName = "missing.json" };
